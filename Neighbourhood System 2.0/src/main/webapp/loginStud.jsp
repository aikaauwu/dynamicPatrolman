...
function validate()
{ 
     var studUsername = document.form.studUsername.value; 
     var studPassword = document.form.studPassword.value;
 
     if (studUsername==null || studUsername=="")
     { 
     alert("studUsername cannot be blank"); 
     return false; 
     }
     else if(studPassword==null || studPassword=="")
     { 
     alert("studPassword cannot be blank"); 
     return false; 
     } 
}
</script> 
					...
					<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
							 ...
							 <form name="form" action="LoginStudentServlet" method="post" onsubmit="return validate()" class="mt">
